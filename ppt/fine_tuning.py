...
register_coco_instances("arrow_train", {}, "./hdBPMN2021/train.json", "./hdBPMN2021/train")
register_coco_instances("arrow_test", {}, "./hdBPMN2021/test.json", "./hdBPMN2021/test")
...
if __name__ == '__main__':
    ...
    print('-----train begin-----')
    model_param = 'model_final_keypoint_detection.pth'
    cfg = get_cfg()
    ...
    cfg.SOLVER.MAX_ITER = 5000  # 10000 iterations seems good enough for this toy dataset; you will need to train longer for a practical dataset
    ...
    checkpointer.save('model_final_fine_tuning_hdBPMN')
    print('-----train end------')
