...
class predict_mode:
    ...
    def predict_flowchart(self, img_path, arrow_metadata=None, save_path=None):
        ...
        cfg.MODEL.WEIGHTS = os.path.join(cfg.OUTPUT_DIR,
                                         "model_final_hdBPMN.pth")  # "model_final_keypoint_detection.pth")  # path to the model we just trained
            ...
            if pred_classes[i] in [12, 13, 14]:
                ...
                for pred_keypoint in pred_keypoints[i]:
                    ...
                    for j, box in enumerate(pred_boxes):
                        if pred_classes[j] not in [12, 13, 14]:
