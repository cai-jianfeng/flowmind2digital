...
# In[]
app.connect(page=page, shp1=shp1, shp2=shp2, shp1_point=0, shp2_point=2)
app.connect(page=page, shp1=shp2, shp2=shpa, shp1_point=0, shp2_point=2)
app.connect(page=page, shp1=shp2, shp2=shpb, shp1_point=0, shp2_point=2)
app.connect(page=page, shp1=shp2, shp2=shpc, shp1_point=0, shp2_point=2)
app.connect(page=page, shp1=shp2, shp2=shpd, shp1_point=0, shp2_point=2)
app.connect(page=page, shp1=shpa, shp2=shp5, shp1_point=0, shp2_point=2)
app.connect(page=page, shp1=shpb, shp2=shp3, shp1_point=0, shp2_point=2)
app.connect(page=page, shp1=shpc, shp2=shp3, shp1_point=0, shp2_point=2)
app.connect(page=page, shp1=shpd, shp2=shp3, shp1_point=0, shp2_point=2)
app.connect(page=page, shp1=shp5, shp2=shp3, shp1_point=1, shp2_point=3)
app.connect(page=page, shp1=shp3, shp2=shp4, shp1_point=1, shp2_point=3)
app.connect(page=page, shp1=shp5, shp2=shp6, shp1_point=0, shp2_point=2)
app.connect(page=page, shp1=shp6, shp2=shp7, shp1_point=0, shp2_point=2)
app.connect(page=page, shp1=shp7, shp2=shp8, shp1_point=1, shp2_point=3)
app.connect(page=page, shp1=shp8, shp2=shp9, shp1_point=1, shp2_point=3)
app.connect(page=page, shp1=shp7, shp2=shp10, shp1_point=0, shp2_point=2)
app.connect(page=page, shp1=shp9, shp2=shp11, shp1_point=0, shp2_point=2)
app.connect(page=page, shp1=shp11, shp2=shp10, shp1_point=3, shp2_point=1)
app.connect(page=page, shp1=shp11, shp2=shp12, shp1_point=1, shp2_point=3)
app.connect(page=page, shp1=shp10, shp2=shp13, shp1_point=0, shp2_point=2)
app.connect(page=page, shp1=shp13, shp2=shp14, shp1_point=0, shp2_point=2)
