...
for d in ['train', 'val']:
    ...
    MetadataCatalog.get('sketch_' + d).set(thing_classes=['{}'.format(categ) for categ in category.keys()])
...
trainer.train()
# Save the model
# torch.save(trainer.model.state_dict(), './output/model_final_object_detection.pth')
checkpointer = DetectionCheckpointer(trainer.model, save_dir=cfg.OUTPUT_DIR)
checkpointer.save('model_final_object_detection.pth')
print('-----train end------')
